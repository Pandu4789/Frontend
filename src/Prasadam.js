...
const Prasadam = () => {
  ...
  const allRestaurantsData = [
    {
      ...
      imageUrl:
        "https://via.placeholder.com/600x400/F0D55C/4A2000?text=Divine+Delights",
    ...
    },
    {
      ...
      description:
        "Traditional North Indian Thali and daily special offerings.",
      imageUrl:
        "https://via.placeholder.com/600x400/4A2000/FFD700?text=Bhakti+Bhojan",
    ...
    },
    {
      ...
      imageUrl:
        "https://via.placeholder.com/600x400/B74F2F/FDF5E6?text=Ananda+Food+Hub",
    ...
    rest1: [
      {
        ...
        category: "Sweets",
        price: 50,
        imageUrl: "https://via.placeholder.com/150/FDEBC1?text=Laddu",
        available: true,
        description: "Classic sweet made with gram flour and ghee.",
      },
      {
        id: "item2",
        name: "Puliyodharai Rice",
        category: "Meals",
        price: 120,
        imageUrl: "https://via.placeholder.com/150/4A2000?text=Puliyodharai",
        available: true,
        description: "Tangy tamarind rice, South Indian style.",
      },
      {
        id: "item3",
        ...
        category: "Savories",
        price: 60,
        imageUrl: "https://via.placeholder.com/150/B74F2F?text=Medu+Vada",
        available: true,
      ...
      },
      {
        ...
        category: "Sweets",
        price: 80,
        imageUrl: "https://via.placeholder.com/150/FFD700?text=Sakkarai+Pongal",
        available: false,
        description: "Sweet rice pudding with jaggery.",
      },
      {
        id: "item5",
        name: "Lemon Rice",
        category: "Meals",
        price: 100,
        imageUrl: "https://via.placeholder.com/150/FDF5E6?text=Lemon+Rice",
        available: true,
        description: "Flavorful rice with lemon and spices.",
      },
      {
        id: "item6",
        name: "Filter Coffee",
        category: "Drinks",
        price: 40,
        imageUrl: "https://via.placeholder.com/150/8E2DE2?text=Filter+Coffee",
        available: true,
    ...
    rest2: [
      {
        ...
        category: "Sweets",
        price: 70,
        imageUrl: "https://via.placeholder.com/150/4A2000?text=Gajar+Halwa",
        available: true,
        description: "Carrot pudding, rich and creamy.",
      },
      {
        id: "item8",
        name: "Punjabi Thali",
        category: "Thali",
        price: 180,
        imageUrl: "https://via.placeholder.com/150/FFD700?text=Punjabi+Thali",
        available: true,
        description: "Assorted North Indian breads, curries, and rice.",
      },
      {
        id: "item9",
        name: "Samosa (1 pc)",
        category: "Snacks",
        price: 25,
        imageUrl: "https://via.placeholder.com/150/B74F2F?text=Samosa",
        available: true,
      ...
      },
      {
        ...
        category: "Drinks",
        price: 60,
        imageUrl: "https://via.placeholder.com/150/FDEBC1?text=Lassi",
        available: true,
    ...
    rest3: [
      {
        ...
        category: "Meals",
        price: 160,
        imageUrl: "https://via.placeholder.com/150/FDF5E6?text=Yoga+Bowl",
        available: true,
        description: "Balanced meal with grains, veggies, and protein.",
      },
      {
        id: "item12",
        ...
        category: "Juices",
        price: 70,
        imageUrl: "https://via.placeholder.com/150/8E2DE2?text=Fresh+Juice",
        available: true,
      ...
      },
      {
        ...
        category: "Sweets",
        price: 45,
        imageUrl: "https://via.placeholder.com/150/F0D55C?text=Oats+Laddu",
        available: true,
        description: "Healthy sweet treat with oats.",
      },
    ],
  };
  ...
  const currentCategories = selectedRestaurantId
    ? [
        "All",
        ...new Set(
          allMenusData[selectedRestaurantId]?.map((i) => i.category) || [],
        ),
      ]
    : [];

  const selectedRestaurant = restaurantsList.find(
        ...
        <div className="prasadam-container">
          <div className="prasadam-header menu-header">
            ...
            <p className="menu-location">
              <FaMapMarkerAlt /> {selectedRestaurant?.location}
            </p>
            <button
          ...
          <div className="prasadam-grid">
            {filteredItems.length > 0 ? (
              ...
              <p className="no-items-message">
                No items available for this category or restaurant.
              </p>
            )}
          </div>
        </div>
