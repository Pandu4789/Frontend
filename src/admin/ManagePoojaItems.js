...
const initialFormState = { itemName: '', quantity: 1, unitPrice: 0, unit: 'count' };
                    ...
                    <div className="pim-form-card">
                        <form onSubmit={handleSubmit} className="pim-form">
                            ...
                            <div className="pim-form-group quantity">
                                ...
                                <input id="quantity" type="number" name="quantity" value={form.quantity} onChange={handleChange} min="1" required />
                            </div>
                            ...
                            <div className="pim-form-group unit-price">
                                ...
                                <input id="unitPrice" type="number" name="unitPrice" value={form.unitPrice} onChange={handleChange} min="0" step="0.01" required />
                            </div>
                        ...
                        <table className="items-table">
                            ...
                            <tbody>
                                {items.length > 0 ? (
                                    ...
                                    <tr><td colSpan="4" style={{ textAlign: 'center', padding: '20px' }}>No items found for this event. Click 'Add New Item' to begin.</td></tr>
                                )}
                            </tbody>
                            <tfoot>
                                <tr>
                                    {/* ✅ 4. CHANGED: Updated colSpan from 3 to 2 to maintain alignment. */}
                                    <td colSpan="2" className="total-label">Total Estimated Price:</td>
