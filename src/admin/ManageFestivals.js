...
const ManageFestivals = () => {
  ...
  const handleEdit = (festival) => {
    ...
    setCurrentFestival({
      ...festival,
      date: format(parseISO(festival.date), "yyyy-MM-dd"),
    });
    setIsModalOpen(true);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success(
        `Festival ${isEditing ? "updated" : "added"} successfully!`,
      );
      handleCloseModal();
      fetchFestivals();
    } catch (err) {
    ...
    <>
      ...
      <div className="manage-festivals-container">
        ...
        <div className="mf-header">
          ...
          <button className="mf-add-btn" onClick={handleAddNew}>
            <FaPlus /> Add New Festival
          </button>
        </div>
        ...
        {isLoading ? (
          <p className="loading-error-message">Loading festivals...</p>
        ) : (
          <ul className="festival-list">
            ...
            {filteredFestivals.length === 0 && (
              <li className="loading-error-message">
              ...
              <form onSubmit={handleSubmit} className="admin-modal-body">
                ...
                <div className="admin-modal-footer">
                  ...
                  <button type="submit" className="btn btn-primary">
                    {isEditing ? "Update Festival" : "Add Festival"}
                  </button>
                </div>
              </form>
            </div>
