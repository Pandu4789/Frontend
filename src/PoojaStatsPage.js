    ...
    <div className="am-modal-backdrop">
      <div className="am-modal-content small">
        <div className="am-modal-header">
          ...
          <button className="am-modal-close-btn" onClick={onClose}>
            <FaTimes />
          </button>
        </div>
        ...
        <div className="am-modal-footer">
          <button className="am-modal-btn-secondary" onClick={onClose}>
            Cancel
          </button>
          <button
            className="am-modal-btn-primary"
  ...
  return (
    <div className="stats-page-container">
      ...
      <div className="report-description-card">
        ...
        <p>
          Create and download detailed PDF reports for your bookings and
          appointments. You can filter your reports by month, year, or a custom
          date range to get the exact information you need for your records.
        </p>
        <button
          className="pd-action-btn primary large"
