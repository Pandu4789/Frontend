...
import { FaStar, FaPhoneAlt, FaTimes, FaCheckCircle, FaInfoCircle, FaUserCircle } from 'react-icons/fa';
...
const HoroscopeModal = ({ priest, onClose }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    toast.info(`The automated horoscope request system is currently being finalized.`);
  };
  ...
  return (
    <div className="hm-overlay">
      <div className="hm-card">
        ...
        <button className="hm-close" onClick={onClose}><FaTimes /></button>
          ...
          <div className="hm-summary-side">
            ...
            <div className="hm-trust-badges">
              <div className="hm-trust-item">
                <FaCheckCircle className="icon-green" /> Personalized Chart Analysis
              </div>
              <div className="hm-trust-item">
          ...
          <div className="hm-form-side">
            ...
            <div className="hm-info-body">
              <p className="hm-main-text">
                Request a comprehensive horoscope reading and astrological consultation with <strong>{priest.firstName}</strong>.
              </p>
              ...
              <div className="hm-contact-note">
                ...
                <div>
                  ...
                  <p className="hm-note-desc">
                    To schedule a reading immediately, please contact the priest at:
                  </p>
              ...
              <div className="hm-coming-soon">
                  ...
                  <p>In-app booking for digital charts and recorded consultations is being implemented.</p>
              </div>
            </div>

            <footer className="hm-actions">
              <button className="hm-btn-cancel" onClick={onClose}>Close</button>
