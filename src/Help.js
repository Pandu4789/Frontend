      ...
      <div className="help-container">
        <header className="help-header">
          ...
          <p className="help-subtitle">
            Our team is dedicated to ensuring your spiritual journey is seamless
            and sacred.
          </p>
        </header>
        ...
        <div className="help-grid">
          ...
          <div className="help-card">
            ...
            <a href="tel:+19402798585" className="help-link">
              +1 (940) 279-8585
            </a>
          </div>
          ...
          <div className="help-card">
            ...
            <a href="mailto:support@priestify.com" className="help-link">
              support@priestify.com
            </a>
          </div>
        ...
        <section className="support-action-section">
          <div className="whatsapp-box">
            ...
            <button
              ...
              onClick={() => window.open("https://wa.me/19402798585", "_blank")}
            >
              Start Chat
            </button>
          </div>
