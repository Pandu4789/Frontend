...
const AskForMuhurtam = ({
  ...
  return (
    <div className="am-overlay">
      ...
      <div
        className={`am-card ${Object.keys(errors).length > 0 ? "animate-shake" : ""}`}
      >
        ...
        {showConfirmation ? (
          <div className="am-success-view">
            ...
            <button onClick={onClose} className="am-btn-finish">
              Understood
            </button>
          </div>
        ) : (
          <div className="am-split-container">
            <div className="am-summary-side">
              ...
              <div className="am-trust-badges">
                <div className="am-trust-item">
                  <FaCheckCircle className="icon-green" /> Vedic Time
                  Calculation
                </div>
                <div className="am-trust-item">
                  <FaStar className="icon-green" /> Tithi & Nakshatram Alignment
                </div>
              </div>
            </div>
            ...
            <div className="am-form-side">
              ...
              <div className="am-field">
                <label className={errors.nakshatram ? "error-label" : ""}>
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    setErrors({ ...errors, nakshatram: false });
                  }}
                >
                ...
                <button
                  type="button"
                  className="am-helper-btn"
                  onClick={() => setShowBirthDetailsPopup(true)}
                >
        ...
        {showBirthDetailsPopup && (
          <div className="am-modal-overlay-inner">
            ...
            <div
              className={`am-modal-inner ${Object.keys(birthErrors).length > 0 ? "animate-shake" : ""}`}
            >
              ...
              <div className="am-modal-inner-grid">
                <div className="am-field">
                  <label className={birthErrors.birthDate ? "error-label" : ""}>
                    Date of Birth
                  </label>
                  <input
                    type="date"
                    ...
                    onChange={(e) => {
                      ...
                      setBirthErrors({ ...birthErrors, birthDate: false });
                    }}
                    className={`am-input ${birthErrors.birthDate ? "error-border" : ""}`}
                  />
                </div>
                <div className="am-field">
                  <label className={birthErrors.birthTime ? "error-label" : ""}>
                    Time of Birth
                  </label>
                  <input
                    type="time"
                    ...
                    onChange={(e) => {
                      ...
                      setBirthErrors({ ...birthErrors, birthTime: false });
                    }}
                ...
                <div className="am-field full-span">
                  <label
                    className={birthErrors.birthPlace ? "error-label" : ""}
                  >
                    Place of Birth
                  </label>
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setBirthErrors({ ...birthErrors, birthPlace: false });
                    }}
              ...
              <div className="am-modal-inner-footer">
                <button
                  className="am-btn-save-inner"
                  onClick={handleSaveBirthDetails}
                >
                  Save Details
                </button>
                <button
                  className="am-btn-back-inner"
                  onClick={() => {
                    setShowBirthDetailsPopup(false);
                    setBirthErrors({});
                  }}
